...
<template>
  <div class="h-full md:py-3 text-white">
    <div class="fixed md:static z-10 flex flex-col justify-between h-full bg-blue-500 dark:bg-blue-900 md:rounded-r-lg shadow py-2 w-full md:w-72 overflow-y-auto" :class="isExpanded ? 'block': 'hidden'">
      <div>
