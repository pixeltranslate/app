...
export default antfu(
  {
    ...
    // TODO: We can enable these at some later point to also get consistently formatted & linted yaml
    yaml: false,
    ...
    rules: {
      ...
      // https://github.com/sidestream-tech/hanselmann-os/pull/2262/#discussion_r1511446129
  ...
  // Disallow `publicProcedure` usage in any router
  {
    ignores,
    ...
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          message: 'Please don\'t use `publicProcedure` directly. It is unsecure.',
          selector: 'MemberExpression > Identifier[name="publicProcedure"]',
        },
      ],
    },
  },
